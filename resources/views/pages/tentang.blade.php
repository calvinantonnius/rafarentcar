...
<style>
    ...
    * {
    ...
    /* Seluruh style CSS yang sudah kamu buat tetap di sini */
    /* .about-bg-pattern {
        background-image: 
...
<section id="about" class="py-20 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 lg:px-8 relative z-10 space-y-24 pt-10">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div class="stat-card text-center p-6 bg-white rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                            <div class="stat-number text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-2 counter">250</div>
