...
<head>
    ...
    <title>Detail Mobil - RafaRentCar</title>
...
<body class="bg-pattern">
    <div class="main-container">
        ...
        <!-- Bagian Detail Mobil -->
        <div class="car-detail-card loading-animation mb-10">
            <div class="p-8">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    ...
                    <div>
                        <div class="info-badge">
                            <i class="fas fa-crown mr-1"></i>Premium Luxury
                        </div>
                        
                        <h2 class="car-title">Jaguar XE L P250</h2>
                        ...
                        <div class="flex flex-wrap gap-2 mb-4">
                            ...
                            <span class="features-badge">
                                <i class="fas fa-users"></i>4 Penumpang
                            </span>
                            <span class="features-badge">
                        ...
                        <p class="car-description">
                            Jaguar XE L P250 merupakan mobil mewah dengan performa tinggi dan desain elegan, cocok untuk perjalanan bisnis maupun pribadi. Dilengkapi dengan teknologi terdepan dan interior premium yang memberikan pengalaman berkendara yang tak terlupakan.
                        </p>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="catatan" 
                                      class="form-input" 
                                      rows="3" 
                                      placeholder="Permintaan khusus atau catatan lainnya (opsional)"></textarea>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                setTimeout(() => {
                    alert('Permintaan sewa berhasil dikirim! Tim kami akan menghubungi Anda segera.');
                    submitBtn.innerHTML = '<i class="fas fa-paper-plane mr-2"></i>Kirim Permintaan Sewa';
